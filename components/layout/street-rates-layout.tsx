...
import { StreetRatesSidebar } from "./street-rates-sidebar"
import { MODULE_CONFIG, getModuleByPath } from "@/lib/config/modules"

interface StreetRatesLayoutProps {
  children: React.ReactNode
}

export function StreetRatesLayout({ children }: StreetRatesLayoutProps) {
  const [currentModule, setCurrentModule] = useState("street-rates")
