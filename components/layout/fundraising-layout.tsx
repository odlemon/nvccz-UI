...
import { FundraisingSidebar } from "./fundraising-sidebar"
import { MODULE_CONFIG, getModuleByPath } from "@/lib/config/modules"

interface FundraisingLayoutProps {
  children: React.ReactNode
}

export function FundraisingLayout({ children }: FundraisingLayoutProps) {
  const [currentModule, setCurrentModule] = useState("fundraising")
