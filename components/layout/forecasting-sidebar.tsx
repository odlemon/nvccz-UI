...
export function ForecastingSidebar() {
  ...
  const accessibleSubModules = useMemo(() => {
    ...
    return module.subModules.filter((subModule) =>
      hasSubModuleAccess("forecasting", subModule.id)
    )
            ...
            return (
              <Button
                ...
                className={cn(
                  ...
                  active &&
                    "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg rounded-full hover:from-blue-600 hover:to-blue-700",
                )}
