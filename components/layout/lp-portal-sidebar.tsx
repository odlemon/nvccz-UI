...
export function LpPortalSidebar() {
  const pathname = usePathname()
  const module = getModuleById("lp-portal")
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  !active && "hover:bg-gradient-to-r hover:from-teal-50 hover:to-teal-100 hover:rounded-full",
                  active && "bg-gradient-to-r from-teal-500 to-teal-600 text-white shadow-lg rounded-full hover:from-teal-600 hover:to-teal-700",
                )}
              >
