...
export function WorkflowTaskDetailPanel({
  ...
  if (!task) {
    return (
      <aside className="h-full min-h-[420px] flex-1 rounded-xl border border-[#e2e8f0] bg-white p-5 flex flex-col items-center justify-center text-center shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
  ...
  return (
    <aside className="h-full min-h-[420px] flex-1 rounded-xl border border-[#e2e8f0] bg-white flex flex-col overflow-hidden shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
      <div className="flex items-start justify-between gap-2 px-4 py-3.5 border-b border-[#e2e8f0]">
      ...
      {controls.banner ? (
        <div className="mx-4 mt-3 flex items-start gap-2 rounded-lg border border-[#e2e8f0] bg-[#f8fafc] px-3 py-2.5">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 text-sm">
        ...
        <section>
          ...
          <div className="space-y-2.5 mb-2 max-h-36 overflow-y-auto">
