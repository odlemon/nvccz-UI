...
| Investee Portal (founder) | `feature/investee-portal-v8-live` | [`investee-portal-v8/HANDOFF_AND_TEST_PLAN.md`](./investee-portal-v8/HANDOFF_AND_TEST_PLAN.md), `investee-portal-v8/TEST_FINDINGS.md` | In progress — Phase 6 (runtime patch-script safety net) done |
