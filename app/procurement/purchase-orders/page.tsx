...
export default function PurchaseOrdersPage() {
  ...
  return (
    <ModuleGuard moduleId="procurement" subModule="purchase-orders" fallback={
      <ProcurementLayout>
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            <p className="text-lg font-semibold text-gray-900 mb-2">Access Denied</p>
            <p className="text-sm text-gray-500">You don't have permission to view purchase orders.</p>
          </div>
        </div>
      </ProcurementLayout>
    }>
