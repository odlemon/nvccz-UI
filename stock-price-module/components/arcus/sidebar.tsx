...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Folder Setup', href: '/portfolios/folder-setup' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Simulation', href: '/orders/simulation' },
      { label: 'Models', href: '/orders/models' },
      { label: 'Setup', href: '/orders/setup' },
    ],
  },
  {
    ...
    href: '/reconciliation',
    children: [
      { label: 'Cash Recon', href: '/reconciliation/cash' },
      { label: 'Holdings', href: '/reconciliation/holdings' },
      { label: 'Trade Recon', href: '/reconciliation/trades' },
      { label: 'Exceptions', href: '/reconciliation/exceptions' },
    ],
  },
  {
    label: 'Valuation',
    ...
    href: '/valuation',
    children: [
      { label: 'NAV Runs', href: '/valuation/nav' },
      { label: 'P&L Runs', href: '/valuation/pnl' },
      { label: 'Price Validation', href: '/valuation/prices' },
      { label: 'FX Conversion', href: '/valuation/fx' },
    ],
  },
  {
    label: 'Reporting',
    ...
    href: '/reporting',
    children: [
      { label: 'Portfolio Reports', href: '/reporting/portfolio' },
      { label: 'P&L Reports', href: '/reporting/pnl' },
      { label: 'Trade Reports', href: '/reporting/trades' },
    ],
  },
  {
    label: 'Documentation',
    ...
    href: '/documentation',
    children: [
      { label: 'Document Register', href: '/documentation' },
      { label: 'Upload', href: '/documentation/upload' },
    ],
  },
  {
    label: 'Accounting',
    ...
    href: '/accounting',
    children: [
      { label: 'Events', href: '/accounting/events' },
