...
export const PM_NAV_ITEMS: PmNavItem[] = [
  ...
  { id: "performance-contracts", label: "Contracts", href: "/performance/contracts", icon: "Medal" },
...
export const PM_NAV_GROUPS: PmNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "alerts", label: "Alerts", href: "/performance/alerts", icon: "Bell" },
  ...
  },
  {
    ...
    icon: "Settings",
    items: [
      { id: "kpi-analytics", label: "Analytics", href: "/performance/kpi-analytics", icon: "PieChart" },
      { id: "kpi-management", label: "KPIs", href: "/performance/kpis", icon: "LineChart" },
      { id: "bsc-entry", label: "BSC Entry", href: "/performance/tasks?tab=bsc-entry", icon: "Coins" },
      { id: "workflow-history", label: "Workflow", href: "/performance/tasks?tab=workflow", icon: "GitBranch" },
      { id: "departments-management", label: "Departments", href: "/performance/departments", icon: "Building" },
      { id: "config-pillars", label: "Pillars", href: "/performance/configuration/pillars", icon: "Columns3" },
