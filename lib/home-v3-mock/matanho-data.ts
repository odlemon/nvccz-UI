...
export const MATANHO_DATA = {
  user: {
    ...
    initials: 'FM',
    image: '/home/assets/people/fadzai.jpg'
  },
  quotes: [
  ...
  people: [
    { id: 'nyasha', name: 'Nyasha Moyo', initials: 'NM', image: '/home/assets/people/nyasha.jpg', role: 'Senior Investment Analyst', team: 'Investments', location: 'Harare', status: 'Available now', statusType: 'available', expertise: ['Financial analysis','ESG','Modelling'], email: 'nyasha.moyo@matanho.co.zw', phone: '+263 77 312 8542', manager: 'Tawanda Kasere', projects: ['Zambia Solar Fund II','Energy Transition Mandate','ESG Integration Framework'], score: 92 },
    { id: 'tawanda', name: 'Tawanda Kasere', initials: 'TK', image: '/home/assets/people/tawanda.jpg', role: 'Portfolio Manager', team: 'Investments', location: 'Harare', status: 'In a meeting', statusType: 'meeting', expertise: ['Portfolio strategy','Private equity','ESG'], email: 'tawanda.kasere@matanho.co.zw', phone: '+263 77 201 6638', manager: 'Chipo Dube', projects: ['Southern Africa Expansion','Q3 Portfolio Review'], score: 88 },
    { id: 'rudo', name: 'Rudo Maposa', initials: 'RM', image: '/home/assets/people/rudo.jpg', role: 'Client Relations Manager', team: 'Client Relations', location: 'Harare', status: 'Available now', statusType: 'available', expertise: ['Client engagement','Stakeholder relations'], email: 'rudo.maposa@matanho.co.zw', phone: '+263 78 122 9043', manager: 'Nyasha Moyo', projects: ['Institutional Client Onboarding','Investor Communications'], score: 89 },
    { id: 'farai', name: 'Farai Dube', initials: 'FD', image: '/home/assets/people/farai.jpg', role: 'Operations Manager', team: 'Operations', location: 'Bulawayo', status: 'Available now', statusType: 'available', expertise: ['Process optimisation','Risk management'], email: 'farai.dube@matanho.co.zw', phone: '+263 77 033 1921', manager: 'Fadzai Moyo', projects: ['Finance Close Automation','Vendor Governance'], score: 86 },
    { id: 'chipo', name: 'Chipo Ndlovu', initials: 'CN', image: '/home/assets/people/chipo.jpg', role: 'People Business Partner', team: 'People & Culture', location: 'Harare', status: 'Busy until 15:00', statusType: 'busy', expertise: ['Employee relations','Change management'], email: 'chipo.ndlovu@matanho.co.zw', phone: '+263 77 405 5177', manager: 'Fadzai Moyo', projects: ['Leadership Programme','Performance Framework'], score: 91 },
    { id: 'tinashe', name: 'Tinashe Chaka', initials: 'TC', image: '/home/assets/people/tinashe.jpg', role: 'Finance Manager', team: 'Finance', location: 'Harare', status: 'Available now', statusType: 'available', expertise: ['Financial reporting','Budgeting','Forecasting'], email: 'tinashe.chaka@matanho.co.zw', phone: '+263 78 221 7821', manager: 'Fadzai Moyo', projects: ['Q3 Forecast','Management Accounts'], score: 90 },
    { id: 'lerato', name: 'Lerato Maseko', initials: 'LM', image: '/home/assets/people/lerato.jpg', role: 'People & Culture Adviser', team: 'People & Culture', location: 'Mutare', status: 'Available now', statusType: 'available', expertise: ['Talent development','Learning'], email: 'lerato.maseko@matanho.co.zw', phone: '+263 77 988 3055', manager: 'Chipo Ndlovu', projects: ['Graduate Programme','Learning Academy'], score: 87 },
    { id: 'danai', name: 'Danai Chirwa', initials: 'DC', image: '/home/assets/people/danai.jpg', role: 'Investment Associate', team: 'Investments', location: 'Harare', status: 'Out of office', statusType: 'away', expertise: ['Financial analysis','Valuation','Modelling'], email: 'danai.chirwa@matanho.co.zw', phone: '+263 78 443 9600', manager: 'Tawanda Kasere', projects: ['Zambia Solar Fund II','Market Insights'], score: 84 }
  ],
  news: [
    { id: 1, source: 'Matanho Newsroom', category: 'Company', title: 'Matanho expands its investment research capability', excerpt: 'A new research unit will deepen sector intelligence and strengthen investment decisions across the region.', time: '2h ago', read: '6 min', tone: 'navy', image: '/home/assets/news/research-capability.jpg' },
    { id: 2, source: 'Market Brief', category: 'Markets', title: 'Renewable energy investment accelerates across Southern Africa', excerpt: 'Policy reform and private capital are creating a stronger pipeline of investable clean-energy projects.', time: '1h ago', read: '5 min', tone: 'sage', image: '/home/assets/news/renewable-energy.jpg' },
    { id: 3, source: 'Africa Capital', category: 'Investment', title: 'Private markets enter a more disciplined growth cycle', excerpt: 'Fund managers are placing greater emphasis on operating evidence, cash conversion and governance quality.', time: '3h ago', read: '4 min', tone: 'sand', image: '/home/assets/news/private-markets.jpg' },
    { id: 4, source: 'Matanho Newsroom', category: 'People', title: 'Matanho welcomes its 2026 graduate analyst cohort', excerpt: 'The programme combines investment training, mentorship and meaningful project exposure.', time: '5h ago', read: '3 min', tone: 'blue', image: '/home/assets/news/graduates.jpg' },
    { id: 5, source: 'Technology Review', category: 'Technology', title: 'AI governance becomes a board-level investment question', excerpt: 'Institutional investors are asking for more transparent operating controls and responsible adoption plans.', time: '6h ago', read: '7 min', tone: 'coral', image: '/home/assets/news/ai-governance.jpg' },
    { id: 6, source: 'Infrastructure Africa', category: 'Africa', title: 'Regional infrastructure pipeline strengthens', excerpt: 'New transport and energy projects could unlock trade corridors and lower logistics costs.', time: '8h ago', read: '5 min', tone: 'teal', image: '/home/assets/news/infrastructure.jpg' }
  ],
  newsletters: [
