...
export const MODULE_CONFIG: ModuleConfig[] = [
  ...
  },
  {
    ...
    path: "/home-v3",
    subModules: [
      { id: "hv3-home", name: "Home", path: "/home-v3", icon: CiHome, description: "Personal home" },
      { id: "hv3-cover", name: "Daily Cover", path: "/home-v3/cover", icon: CiFileOn, description: "Daily cover studio" },
      { id: "hv3-news", name: "News", path: "/home-v3/news", icon: CiFileOn, description: "News" },
      { id: "hv3-newsletters", name: "Newsletters", path: "/home-v3/newsletters", icon: Mail, description: "Newsletters" },
      { id: "hv3-forums", name: "Forums", path: "/home-v3/forums", icon: CiText, description: "Forums" },
      { id: "hv3-calendar", name: "Calendar", path: "/home-v3/calendar", icon: CiCalendar, description: "Calendar" },
      { id: "hv3-work", name: "My Work", path: "/home-v3/work", icon: Briefcase, description: "My Work" },
      { id: "hv3-performance", name: "Performance", path: "/home-v3/performance", icon: CiTrophy, description: "Performance" },
      { id: "hv3-people", name: "People", path: "/home-v3/people", icon: Users, description: "People" },
      { id: "hv3-profile", name: "My Profile", path: "/home-v3/profile", icon: CiUser, description: "My Profile" },
      { id: "hv3-services", name: "Services", path: "/home-v3/services", icon: HeartHandshake, description: "Services" },
      { id: "hv3-apps", name: "Apps", path: "/home-v3/apps", icon: CiGrid41, description: "Apps" },
      { id: "hv3-search", name: "Matanho AI", path: "/home-v3/search", icon: Sparkles, description: "Matanho AI" },
    ],
  },
  {
    id: "portfolio-v11",
  ...
  },
  {
    ...
    path: "/procurement",
    subModules: [
      { id: "pr23-dashboard", name: "Command Centre", path: "/procurement", icon: CiGrid41, description: "Command Centre" },
      { id: "pr23-plan", name: "Annual Procurement Plan", path: "/procurement/plan", icon: CiCalendar, description: "Annual procurement plan" },
      { id: "pr23-approvals", name: "Approval Centre", path: "/procurement/approvals", icon: CiFileOn, description: "Approval centre" },
      { id: "pr23-requisitions", name: "Purchase Requisitions", path: "/procurement/requisitions", icon: CiFileOn, description: "Purchase requisitions" },
      { id: "pr23-tenders", name: "Tenders & RFx", path: "/procurement/tenders", icon: CiShop, description: "Tenders and RFx" },
      { id: "pr23-evaluation", name: "Bid Evaluation", path: "/procurement/evaluation", icon: CiViewTimeline, description: "Bid evaluation" },
      { id: "pr23-vendors", name: "Vendor Registry", path: "/procurement/vendors", icon: CiUser, description: "Vendor registry" },
      { id: "pr23-contracts", name: "Contracts & Awards", path: "/procurement/contracts", icon: CiFileOn, description: "Contracts and awards" },
      { id: "pr23-orders", name: "Purchase Orders", path: "/procurement/purchase-orders", icon: CiShop, description: "Purchase orders" },
      { id: "pr23-receiving", name: "Receiving & Inspection", path: "/procurement/goods-received", icon: CiViewTimeline, description: "Goods received" },
      { id: "pr23-invoices", name: "Invoices & 3-Way Match", path: "/procurement/invoices", icon: CiWallet, description: "Invoices and matching" },
      { id: "pr23-accounts", name: "Accounts & Asset Transfers", path: "/procurement/accounts", icon: CiMoneyCheck1, description: "Accounts and transfers" },
      { id: "pr23-documents", name: "Document Vault", path: "/procurement/documents", icon: CiFileOn, description: "Document vault" },
      { id: "pr23-reports", name: "Reports Vault", path: "/procurement/reports", icon: CiViewTable, description: "Reports vault" },
      { id: "pr23-audit", name: "Audit & Compliance", path: "/procurement/audit", icon: CiViewBoard, description: "Audit and compliance" },
      { id: "pr23-settings", name: "Configuration & RBAC", path: "/procurement/settings", icon: CiSettings, description: "Settings and RBAC" },
    ],
  },
  {
    id: "accounting-v52",
  ...
  },
  {
    ...
    icon: CiViewList,
    color: "oklch(0.56 0.10 220)",
    path: "/procurement-legacy",
    subModules: [
      { id: "procurement-dashboard", name: "Dashboard", path: "/procurement-legacy", icon: CiGrid41, description: "Procurement dashboard" },
      { id: "purchase-requisitions", name: "Purchase Requisitions", path: "/procurement-legacy/requisitions", icon: CiFileOn, description: "Purchase requisitions management" },
      { id: "rfq", name: "RFQ", path: "/procurement-legacy/rfq", icon: CiFileOn, description: "Purchase requisitions management" },
      { id: "quotations", name: "Quotations", path: "/procurement-legacy/quotations", icon: CiShop, description: "Quotations management" },
      { id: "purchase-orders", name: "Purchase Orders", path: "/procurement-legacy/purchase-orders", icon: CiShop, description: "Purchase orders management" },
      { id: "procurement-invoices", name: "Invoices", path: "/procurement-legacy/invoices", icon: CiWallet, description: "Procurement invoices management" },
      { id: "goods-received-notes", name: "Goods Received Notes", path: "/procurement-legacy/goods-received", icon: CiViewTimeline, description: "Goods received notes management" },
      { id: "payments", name: "Payments", path: "/procurement-legacy/payments", icon: CiViewTimeline, description: "Payments management" },
      { id: "ai-intake", name: "AI Invoice Intake", path: "/procurement-legacy/ai-intake", icon: FileText, description: "AI-powered vendor invoice extraction and verification" },
      { id: "three-way-match", name: "3-Way Match", path: "/procurement-legacy/three-way-match", icon: BarChart3, description: "PO vs GRN vs Invoice matching" },
      { id: "cfo-dashboard", name: "CFO Dashboard", path: "/procurement-legacy/cfo-dashboard", icon: TrendingUp, description: "Executive procurement overview and analytics" },
      { id: "approval-configurations", name: "Approval Configurations", path: "/procurement-legacy/approval-configs", icon: CiSettings, description: "Approval workflow configurations" },
      // { id: "approval-requests", name: "My Approvals", path: "/procurement-legacy/approvals", icon: CiCircleCheck, description: "Pending approval requests" }
    ]
  },
  {
    id: "accounting",
