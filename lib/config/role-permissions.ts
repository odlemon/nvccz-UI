...
export const ROLE_PERMISSIONS_MAP: Record<RoleCode, RolePermissions> = {
  ...
  CFO: {
    ...
    modules: [
      ...
      fundraisingModulePermission('CFO')!,
      {
        ...
        access: 'full',
        subModules: {
          'investments-dashboard': 'full',
          'investments-portfolios-overview': 'full',
          'investments-portfolios-instruments': 'full',
          'investments-portfolios-prices': 'full',
          'investments-portfolios-positions': 'full',
          'investments-portfolios-transactions': 'full',
          'investments-portfolios-folder-setup': 'full',
          'investments-portfolios-setup': 'full',
          'investments-orders-blotter': 'full',
          'investments-orders-orderbook': 'full',
          'investments-orders-trading': 'full',
          'investments-orders-compliance': 'full',
          'investments-orders-simulation': 'full',
          'investments-orders-models': 'full',
          'investments-orders-setup': 'full',
          'investments-reconciliation': 'read',
          'investments-valuation': 'read',
          'investments-reporting': 'read',
          'investments-documentation': 'read',
          'investments-accounting': 'read',
          'investments-setup': 'read',
        }
      },
      {
  ...
  FIN_MGR: {
    ...
    modules: [
      ...
      { moduleId: 'investments', access: 'write', subModules: { 'investments-dashboard': 'full', 'investments-portfolios-overview': 'read', 'investments-portfolios-instruments': 'read', 'investments-portfolios-prices': 'read', 'investments-portfolios-positions': 'read', 'investments-portfolios-transactions': 'read', 'investments-portfolios-folder-setup': 'none', 'investments-portfolios-setup': 'none', 'investments-orders-blotter': 'write', 'investments-orders-orderbook': 'write', 'investments-orders-trading': 'write', 'investments-orders-compliance': 'read', 'investments-orders-simulation': 'read', 'investments-orders-models': 'read', 'investments-orders-setup': 'none', 'investments-reconciliation': 'none', 'investments-valuation': 'none', 'investments-reporting': 'none', 'investments-documentation': 'none', 'investments-accounting': 'none', 'investments-setup': 'none' } },
